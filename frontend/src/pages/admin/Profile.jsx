...
export default function AdminProfile() {
  ...
  // Password Show/Hide Toggle States
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    setSavingPw(true)
    try {
      await adminService.changePassword(pwForm)
    ...
    <div className="max-w-2xl space-y-8">
      ...
      <form onSubmit={handleProfileSubmit} className="ticket-card shadow-card p-6 space-y-4">
        <h2 className="font-display font-semibold text-lg flex items-center gap-2 text-ink">
          <ShieldCheck size={18} className="text-mango-dark" /> Personal details
        </h2>
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <button
              ...
              className="absolute inset-y-0 right-3 flex items-center text-gray-500 hover:text-ink transition-colors"
            >
