...
//   useEffect(() => {
//     Promise.all([menuService.getMyMenu(), restaurantService.getOrders()])
...
import { UtensilsCrossed, ClipboardList, Clock, Plus, ListChecks } from 'lucide-react'
import restaurantService from '../../services/restaurantService.js'
import menuService from '../../services/menuService.js'
import { useAuth } from '../../context/AuthContext.jsx'
import OrderCard from '../../components/common/OrderCard.jsx'
...
export default function RestaurantDashboard() {
  //  console.log("RestaurantDashboard Render");
  const { user } = useAuth()
  const [menu, setMenu] = useState([])
  const [orders, setOrders] = useState([])
  const [loading, setLoading] = useState(true)
